...
from tests.functional.test_tag_inheritance import \
    get_inherited_tags, assert_inherited_tags_equal_to
...
class TestIssue(object):
    ...
    def test_scenario_inherits_tags_with_feature(self):
        ...
        expected_tags = {"scenario_tag1", "feature_tag1"}
    ...
    def test_scenario_inherits_tags_with_rule(self):
        ...
        expected_tags = {"scenario_tag1"}.union(inherited_tags)
        assert this_scenario.effective_tags == expected_tags
